...
#ifndef KAHSH_ZKSHWALLET_H
#define KAHSH_ZKSHWALLET_H
...
public:
    CzKSHWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZKSH(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZKSH(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
