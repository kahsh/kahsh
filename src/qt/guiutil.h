...
/** Utility functions used by the Dilithium Qt UI.
 */
namespace GUIUtil
{
...
// Render Dilithium addresses in monospace font
...
// Parse "dilithium:" URI into recipient object, return true on successful parsing
