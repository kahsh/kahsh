...
/** Utility functions used by the Kahsh Qt UI.
 */
namespace GUIUtil
{
...
// Render Kahsh addresses in monospace font
...
// Parse "kahsh:" URI into recipient object, return true on successful parsing
