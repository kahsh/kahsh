...
/* Kahsh GUI -- Size of icons in status bar */
...
#define COLOR_STAKE QColor(181,181,181)
...
#define QAPP_ORG_NAME "Kahsh"
#define QAPP_ORG_DOMAIN "kahsh.io"
#define QAPP_APP_NAME_DEFAULT "Kahsh-Qt"
#define QAPP_APP_NAME_TESTNET "Kahsh-Qt-testnet"
