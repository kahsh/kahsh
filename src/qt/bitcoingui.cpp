                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Dilithium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dilithium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dilithium: URIs)"));
...
//    privacyAction->setStatusTip(tr("Privacy Actions for zXDH"));
...
//    connect(privacyAction, SIGNAL(triggered()), this, SLOT(gotoPrivacyPage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dilithium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dilithium Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Dilithium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dilithium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dilithium addresses"));
    ...
    openAction->setStatusTip(tr("Open a Dilithium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dilithium Core help message to get a list with possible Dilithium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Dilithium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dilithium network", "", count));
}
...
{
    QString strTitle = tr("Dilithium Core"); // default title
    ...
    if (style & CClientUIInterface::MODAL) {
        ...
        if (clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getDisplaySystemNotifications()) {
