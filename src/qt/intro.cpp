...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Dilithium Core"),
     ...
     * override -datadir in the dilithium.conf file in the default data directory
     * (to be consistent with dilithiumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
