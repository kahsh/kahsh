...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Kahsh Core kahsh-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kahsh-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kahsh transaction") + "\n" +
                               "  kahsh-tx [options] -create [commands]   " + _("Create hex-encoded kahsh transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kahsh transaction
