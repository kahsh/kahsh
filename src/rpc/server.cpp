...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"zerocoin", "getzxdhseed", &getzxdhseed, false, false, true},
        {"zerocoin", "setzxdhseed", &setzxdhseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzxdh", &searchdzxdh, false, false, true},
        {"zerocoin", "dzxdhstate", &dzxdhstate, false, false, true}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:52211/\n";
}
