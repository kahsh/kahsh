...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Dilithium Core dilithium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dilithium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dilithium transaction") + "\n" +
                               "  dilithium-tx [options] -create [commands]   " + _("Create hex-encoded dilithium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dilithium transaction
