...
#   c) node1 mines 32 blocks, so now node 0 has 60001xdh, node 1 has 4250xdh, node2 has none.
#   d) node0 sends 601 xdh to node2, in two transactions (301 xdh, then 300 xdh).
