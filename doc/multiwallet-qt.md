...
In order to support loading of multiple wallets in kahsh-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kahsh.cpp.
...
Changes to kahsh.cpp
----------------------
kahsh.cpp is the entry point into kahsh-qt, and as such, will require some minor modifications to provide hooks for
