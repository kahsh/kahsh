...
In order to support loading of multiple wallets in dilithium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dilithium.cpp.
...
Changes to dilithium.cpp
----------------------
dilithium.cpp is the entry point into dilithium-qt, and as such, will require some minor modifications to provide hooks for
