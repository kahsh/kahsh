...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/dilithium-cli.cpp \
           src/dilithium-tx.cpp \
           src/dilithium.cpp \
           src/db.cpp \
           ...
           src/qt/dilithium.cpp \
           src/qt/dilithiumstrings.cpp \
...
RESOURCES += src/qt/dilithium.qrc src/qt/dilithium_locale.qrc

TRANSLATIONS += src/qt/locale/dilithium_bg.ts \
                src/qt/locale/dilithium_de.ts \
                src/qt/locale/dilithium_en.ts \
                src/qt/locale/dilithium_es.ts \
                src/qt/locale/dilithium_fi.ts \
                src/qt/locale/dilithium_fr.ts \
                src/qt/locale/dilithium_it.ts \
                src/qt/locale/dilithium_ja.ts \
                src/qt/locale/dilithium_pl.ts \
                src/qt/locale/dilithium_pt.ts \
                src/qt/locale/dilithium_ru.ts \
                src/qt/locale/dilithium_sk.ts \
                src/qt/locale/dilithium_sv.ts \
                src/qt/locale/dilithium_vi.ts \
                src/qt/locale/dilithium_zh_CN.ts \
                src/qt/locale/dilithium_zh_TW.ts
