...
RESOURCES += src/qt/kahsh.qrc src/qt/kahsh_locale.qrc

TRANSLATIONS += src/qt/locale/kahsh_bg.ts \
                src/qt/locale/kahsh_de.ts \
                src/qt/locale/kahsh_en.ts \
                src/qt/locale/kahsh_es.ts \
                src/qt/locale/kahsh_fi.ts \
                src/qt/locale/kahsh_fr.ts \
                src/qt/locale/kahsh_it.ts \
                src/qt/locale/kahsh_ja.ts \
                src/qt/locale/kahsh_pl.ts \
                src/qt/locale/kahsh_pt.ts \
                src/qt/locale/kahsh_ru.ts \
                src/qt/locale/kahsh_sk.ts \
                src/qt/locale/kahsh_sv.ts \
                src/qt/locale/kahsh_vi.ts \
                src/qt/locale/kahsh_zh_CN.ts \
                src/qt/locale/kahsh_zh_TW.ts
