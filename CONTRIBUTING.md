Contributing to Kahsh Core
============================

The Kahsh Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Kahsh Core project, and is not to be
confused with overall Kahsh Network Protocol consensus changes.

Whether a pull request is merged into Kahsh Core rests with the project merge
...
Patches that change Kahsh consensus rules are considerably more involved than
...
Where a patch set proposes to change the Kahsh consensus, it must have been
...
The project leader is the release manager for each Kahsh Core release.
