Contributing to Dilithium Core
============================

The Dilithium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dilithium Core project, and is not to be
confused with overall Dilithium Network Protocol consensus changes.

Whether a pull request is merged into Dilithium Core rests with the project merge
...
Patches that change Dilithium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dilithium consensus, it must have been
...
The project leader is the release manager for each Dilithium Core release.
